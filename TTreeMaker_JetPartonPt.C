...
void TTreeMaker_JetPartonPt() {
    ...
    df.Snapshot("matched_jets", "rootfiles/matched_jets.root", {
        ...
        "AK2_jet_all_matched_pt", "AK2_jet_all_matched_eta", "AK2_jet_all_matched_phi", "AK2_jet_parton_pt_ratio",
        "AK4_jet_all_matched_pt", "AK4_jet_all_matched_eta", "AK4_jet_all_matched_phi", "AK4_jet_parton_pt_ratio",
        "AK6_jet_all_matched_pt", "AK6_jet_all_matched_eta", "AK6_jet_all_matched_phi", "AK6_jet_parton_pt_ratio",
        "AK8_jet_all_matched_pt", "AK8_jet_all_matched_eta", "AK8_jet_all_matched_phi", "AK8_jet_parton_pt_ratio"
    });
}