...
void histoPlotter() {
    ...
    ROOT::RDF::TH1DModel model_AK2_jet_matched_delR("h1_AK2_jet_matched_delR", "", 200, 0., 2.);
    ROOT::RDF::TH1DModel model_AK4_jet_matched_delR("h1_AK4_jet_matched_delR", "", 200, 0., 2.);
    ROOT::RDF::TH1DModel model_AK6_jet_matched_delR("h1_AK6_jet_matched_delR", "", 200, 0., 2.);
    ROOT::RDF::TH1DModel model_AK8_jet_matched_delR("h1_AK8_jet_matched_delR", "", 200, 0., 2.);
